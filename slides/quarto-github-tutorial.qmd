...
:::{.small}
Editar la configuración en GitHub:

1. Ir a **Settings** > **Pages**.
2. Seleccionar la rama `main` y la carpeta `/ (root)`, o alguna otra carpeta que sea definida para guardar los archivos del sitio web.
